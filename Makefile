...
# Fichiers sources
SRC_FILES = push_swap.c parsing/check_input.c free.c parsing/store.c \
algorithm/init_node_a.c algorithm/sort.c algorithm/move_a_to_b.c algorithm/move_b_to_a.c \
algorithm/sort_three.c rules/moves.c rules/moves_2.c rules/moves_3.c rules/swap.c \
utils/find_utils.c utils/ftt_lstnew.c utils/ftt_lstadd_back.c utils/ftt_lstclear.c utils/printf_list.c \
